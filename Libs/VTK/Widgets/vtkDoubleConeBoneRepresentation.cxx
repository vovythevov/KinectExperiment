...
vtkDoubleConeBoneRepresentation::vtkDoubleConeBoneRepresentation()
{
  ...
  this->GlueFilter->AddInputData( this->Cone1->GetOutput() );
  this->GlueFilter->AddInputData( this->Cone2->GetOutput() );
  this->ConesMapper->SetInputData(this->GlueFilter->GetOutput());
